...
public class Shooter extends SubsystemBase {
    ...
    public Command adjustAmpSpeed(double adjustAmount) {
        return runOnce(
            () -> {
                ampPower += adjustAmount;
            }
        );
    }

    public double getAmpPower() {
        return ampPower;
    }

    public void periodic() {
        SmartDashboard.putNumber("Amp Power", ampPower);
    }
